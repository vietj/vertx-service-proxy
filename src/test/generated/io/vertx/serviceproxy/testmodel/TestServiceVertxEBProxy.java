...
io.vertx.streams.ConsumerStream.open(_vertx.eventBus(), _address, new io.vertx.core.json.JsonObject(), new io.vertx.core.eventbus.DeliveryOptions().addHeader("action", "createStream"), ar -> {
  if (ar.succeeded()) {
